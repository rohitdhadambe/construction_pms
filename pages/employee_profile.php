...
// Query to get employee details, including the project_name field
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
    <div class="col-sm-4 text-right"><label class="control-label">Project name (Working):</label></div>
    <div class="col-sm-8 text-left"><label class="control-label"><?php echo isset($row['project_name_(Working)']) ? $row['project_name'] : 'N/A'; ?></label></div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 text-left"><label class="control-label"><?php echo ($row['io'] == '1') ? 'Active' : 'Inactive'; ?></label></div>
                </div>
                <?php } ?>
            </div>
        </div>
